...
void setup() {
  ...
  balconySystem[0].valveVolume = 0.5;//Watering amount in liters
  ...
  balconySystem[1].valveVolume = 0.5;
  balconySystem[1].valveVolumeCorrection = 0.5;
  //Herbs
  balconySystem[2].valvePin = 27;
  balconySystem[2].valveTime = 82;
  balconySystem[2].valveTimeout = 1200;
  balconySystem[2].valveVolume = 1;
  ...
  balconySystem[3].valveVolume = 0.75;
